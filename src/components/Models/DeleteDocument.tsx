...
export default function DeleteDocument({ setDeleteDoc, deleteDocumentHandle }: DeleteFolderProps) {
    return (
        <div>
            <PopupModel extraCss="sm:w-[400px] !m-0" isOpen={true} onClose={() => setDeleteDoc(null)}>
                ...
                <div className="p-5">
                    <p className="w-[65%] max-sm:w-[80%] mx-auto mb-5 text-center text-[#1E1E1E]">are you sure you want to delete this document ? </p>
